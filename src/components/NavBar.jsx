...
function Toggle() {
  let [lightMode, setLightMode] = useState(0);
  function clickToggle() {
    setLightMode((lightMode + 1) % 3);
  }
  let icon;
  if (lightMode == 0) {
        ...
        <div className="flex h-16 items-center">
          ...
          <div className="hidden lg:flex pr-1 xl:me-2">
            <button
              ...
              class="flex items-center justify-between w-full pl-1 text-gray-600 hover:text-blue-500 md:p-0 md:w-auto"

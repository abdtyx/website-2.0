  ...
  return (
    <Layout content={
      <div className='pt-8 pb-8 dark:text-white'>
        ...
        <div className='flex flex-col gap-4'>
          {courseProjects.map((project, idx) => <ProjectItem key={idx} project={project} />)}
        </div>
      </div>
    } />
  );
